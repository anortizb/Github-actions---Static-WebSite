...
terraform {
    ...
    key            = "github-actions-demo-andresortiz/terraform.tfstate" # Ruta dentro del bucket
...
resource "aws_s3_bucket" "web" {
  ...
  bucket = "andresortiz-githubaccions-demo"
...
resource "aws_s3_bucket_policy" "public_read" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = "arn:aws:s3:::andresortiz-githubaccions-demo/*"
